 ...
 * Generated at: 2022-07-27 08:46:13 UTC
...
public final class sendMail_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t\t\t<form class=\"user\" name=\"frm\" id=\"frm\" method=\"post\" \r\n");
      out.write("\t\t\t\t\t\taction=\"");
      out.print(request.getContextPath());
      out.write("/mail/sendMailProcess\">\r\n");
      out.write("\t\t\t\t\t\t<div class=\"form-group row\">\r\n");
      out.write("\t\t\t\t\t\t\t<div class=\"col-sm-6 mb-3 mb-sm-0\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<input type=\"text\" class=\"form-control form-control-user\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\tid=\"from\" name=\"from\" placeholder=\"보내는 사람\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\tvalue=\"smtp406@naver.com\" readonly/>\r\n");
      out.write("\t\t\t\t\t\t\t\t<input type=\"text\" class=\"form-control form-control-user\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\tid=\"to\" name=\"to\" placeholder=\"받는 사람\" required />\r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t<div class=\"form-group\">\r\n");
      out.write("\t\t\t\t\t\t\t<input type=\"text\" class=\"form-control form-control-user\"\r\n");
      out.write("\t\t\t\t\t\t\t\tid=\"subject\" name=\"subject\" placeholder=\"제목\" required />\r\n");
      out.write("\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t<div class=\"form-group\">\r\n");
      out.write("\t\t\t\t\t\t\t<textarea rows=\"7\" cols=\"5\" name=\"content1\" id=\"content1\"></textarea>\r\n");
      out.write("\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t<button type=\"submit\" class=\"btn btn-primary btn-user btn-block\">메일 보내기</button>\r\n");
      out.write("\t\t\t\t\t</form>\r\n");
      out.write("\t\t\t\t</div>\r\n");
      out.write("\t\t\t</div>\r\n");
      out.write("\t\t</div>\r\n");
      ...
      out.write("\tCKEDITOR.replace(\"content1\");\r\n");
      out.write("</script>");
