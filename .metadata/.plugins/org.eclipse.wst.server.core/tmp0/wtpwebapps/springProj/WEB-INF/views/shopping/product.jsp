...
<%-- 	<jsp:include page="menu.jsp" /> --%>
	...
	<div class="container">
		...
		<div class="row">
			<!-- 6크기의 1열 -->
			<div class="col-md-5">
				<img src="/resources/upload/${ productVO.filename }" alt="${ productVO.pname }" title="${ productVO.pname }" style="width: 100%;cursor: pointer;" onclick="fn_download('${ productVO.filename }')" /></div>
			<div class="col-md-6">
				...
				<h4><fmt:formatNumber type="number" maxFractionDigits="3" value="${ productVO.unitPrice }" /></h4>
				<form name="addForm" action="/product/addCart?id=${ productVO.productId }" method="post">
					<p>
