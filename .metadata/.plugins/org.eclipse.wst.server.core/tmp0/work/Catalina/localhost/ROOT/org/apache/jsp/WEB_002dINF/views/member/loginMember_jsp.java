 ...
 * Generated at: 2022-08-27 08:09:23 UTC
...
public final class loginMember_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t<!-- 로그인을 실패했다면.. -->\r\n");
      out.write("\t\t\t");
      if (_jspx_meth_c_005fif_005f0(_jspx_page_context))
        return;
      out.write("\r\n");
      out.write("<!-- \t\t\t<form class=\"form-dignin\" action=\"/member/processLoginMember\" method=\"post\"> -->\r\n");
      out.write("\t\t\t\t<!-- /member/register?id=a001&password=java -->\r\n");
      out.write("\t\t\t<form class=\"user\" name=\"frm\" action=\"/login\" method=\"post\">\r\n");
      out.write("\t\t\t\t<div class=\"form-group\">\r\n");
      out.write("\t\t\t\t\t<label for=\"inputUserName\" class=\"sr-only\">User Name</label>\r\n");
      out.write("\t\t\t\t\t<input type=\"text\" class=\"form-control\" placeholder=\"ID\" name=\"username\" required autofocus />\r\n");
      out.write("\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t<div class=\"form-group\">\r\n");
      out.write("\t\t\t\t\t<label for=\"inputPassword\" class=\"sr-only\">Password</label>\r\n");
      out.write("\t\t\t\t\t<input type=\"password\" class=\"form-control\" placeholder=\"Password\" name=\"password\" required autofocus />\r\n");
      out.write("\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t<!-- \r\n");
      out.write("\t\t\t\t\t자동 로그인\r\n");
      out.write("\t\t\t\t\t - 로그인하면 특정 시간 동안 다시 로그인 할 필여가 없는 기능(초 단위로 설정)\r\n");
      out.write("\t\t\t\t\t - 스프링 시큐리티는 메모리나 Database(data-source-ref=\"dataSource\")를 사용하여 처리\r\n");
      out.write("\t\t\t\t\t - security:remember-me 태그를 이용하여 security-context.xml 설정 파일을 수정함\r\n");
      out.write("\t\t\t\t -->\r\n");
      out.write("\t\t\t\t<div class=\"form-group\">\r\n");
      out.write("                    <div class=\"custom-control custom-checkbox small\">\r\n");
      out.write("                        <input type=\"checkbox\" class=\"custom-control-input\" id=\"customCheck\" name=\"remember-me\">\r\n");
      out.write("                        <label class=\"custom-control-label\" for=\"customCheck\" style=\"width: 130px;\">Remember\r\n");
      out.write("                            Me</label>\r\n");
      out.write("                    </div>\r\n");
      out.write("                </div>\r\n");
      out.write("\t\t\t\t<!-- button type => submit / button / reset -->\r\n");
      out.write("\t\t\t\t<button type=\"submit\" class=\"btn btn btn-lg btn-success btn-block\">로그인</button>\r\n");
      out.write("\t\t\t\t\r\n");
      out.write("\t\t\t\t");
  ...
  private boolean _jspx_meth_c_005fif_005f0(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /WEB-INF/views/member/loginMember.jsp(23,3) name = test type = boolean reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_c_005fif_005f0.setTest(((java.lang.Boolean) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${ error==1 }", boolean.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null)).booleanValue());
      int _jspx_eval_c_005fif_005f0 = _jspx_th_c_005fif_005f0.doStartTag();
      if (_jspx_eval_c_005fif_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        do {
          out.write("\r\n");
          out.write("\t\t\t\t<div class=\"alert alert-danger\">\r\n");
          out.write("\t\t\t\t\t아이디와 비밀번호를 확인해주세요.\r\n");
          out.write("\t\t\t\t</div>\r\n");
          out.write("\t\t\t");
