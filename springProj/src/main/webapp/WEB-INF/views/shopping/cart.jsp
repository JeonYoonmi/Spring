		...
		<div style="padding-top:50px;">
			<table class="table table-hover">
				...
				<%	// 스크립틀릿
					...
					ArrayList<ProductVO> cartList = (ArrayList<ProductVO>)session.getAttribute("cartlist");	// list : 장바구니{P1234, P1236상품}
			...
			<a href="/product/products" class="btn btn-secondary">&laquo;쇼핑 계속하기</a>
		</div>
		<!-- 장바구니 출력 끝 -->
